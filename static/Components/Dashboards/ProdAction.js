        ...
        <div v-if="this.data.length !== 0" class="d-flex flex-wrap mb-3">
                        <div v-for="i in data" class="card p-0 m-3">
                            ...
                            <div class="card-footer text-end">
                                <button @click="publishProduct(i.product_id)" type="button" class="btn btn-outline-primary m-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Publish Product</button>
                                <button @click="this.editProd.product_id=i.product_id" type="button" class="btn btn-outline-warning m-2" data-bs-toggle="modal" data-bs-target="#exampleModal2">Edit Product</button>
                                <button @click="this.todel=i.product_id" type="button" class="btn btn-outline-danger m-2" data-bs-toggle="modal" data-bs-target="#exampleModal3">Delete product</button>
                            </div>
                        </div>
        </div>
        <div v-else>
